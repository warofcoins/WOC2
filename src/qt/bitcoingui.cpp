...
{
    resize(850, 550);
    setWindowTitle(tr("WOC2") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("warofcoins2");
    setStyleSheet("#warofcoins2 { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #404040, stop: 1 #0E365B);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a WOC2 address"));
    ...
    masternodeManagerAction = new QAction(QIcon(":/icons/bitcoin"), tr("&WOC2 Masternode"), this);
    masternodeManagerAction->setToolTip(tr("Show WOC2 Masternode Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About WOC2"), this);
    aboutAction->setToolTip(tr("Show information about WOC2"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&WarofCoins2s..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for WOC2"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("WOC2 client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("WOC2 client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to WOC2 network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid WOC2 address or malformed URI parameters."));
    }
