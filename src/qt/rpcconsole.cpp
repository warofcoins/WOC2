    ...
    historyPtr(0)
{
    ...
    ui->showCLWarofCoins2sButton->setIcon(QIcon(":/icons/options"));
#endif
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the WOC2 RPC console.") + "<br>" +
...
void RPCConsole::on_showCLWarofCoins2sButton_clicked()
{
