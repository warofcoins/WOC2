...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        string strWhatAmI = "To use warofcoins2d";
        if (mapArgs.count("-server"))
            strWhatAmI = strprintf(_("To use the %s warofcoins2"), "\"-server\"");
        else if (mapArgs.count("-daemon"))
            strWhatAmI = strprintf(_("To use the %s warofcoins2"), "\"-daemon\"");
