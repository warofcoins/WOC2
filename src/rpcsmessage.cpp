...
Value smsgoptions(const Array& params, bool fHelp)
{
    ...
    if (mode == "list")
    {
        result.push_back(Pair("warofcoins2", std::string("newAddressRecv = ") + (smsgOptions.fNewAddressRecv ? "true" : "false")));
        result.push_back(Pair("warofcoins2", std::string("newAddressAnon = ") + (smsgOptions.fNewAddressAnon ? "true" : "false")));
    ...
    if (mode == "set")
    {
        ...
        if (optname == "newAddressRecv")
        {
            ...
            result.push_back(Pair("set warofcoins2", std::string("newAddressRecv = ") + (smsgOptions.fNewAddressRecv ? "true" : "false")));
        } else
        if (optname == "newAddressAnon")
        {
            ...
            result.push_back(Pair("set warofcoins2", std::string("newAddressAnon = ") + (smsgOptions.fNewAddressAnon ? "true" : "false")));
        } else
        {
            result.push_back(Pair("result", "WarofCoins2 not found."));
            return result;
        };
    } else
    {
        result.push_back(Pair("result", "Unknown Mode."));
        result.push_back(Pair("expected", "smsgwarofcoins2 [list|set <optname> <value>]"));
    };
    return result;
}
