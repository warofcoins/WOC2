...
void ThreadIRCSeed()
{
    ...
    RenameThread("warofcoins2-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #warofcoins2coinTEST\r");
            Send(hSocket, "WHO #warofcoins2coinTEST\r");
        } else
        {
	    LogPrintf("JOIN #warofcoins2coin\n");
            // randomly join #warofcoins2coin00-#warofcoins2coin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #warofcoins2coin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #warofcoins2coin%02d\r", channel_number).c_str());
        };
